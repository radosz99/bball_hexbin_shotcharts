...
(function () {
    ...
    var BasketballShotChart = d3.chart('BasketballShotChart', {
        ...
        drawCourt: function () {
            ...
            var base = this.base
                ...
                .attr('viewBox', "0 0 " + courtWidth + " " + 50)
                .append('g')
        ...
        drawTitle: function () {
            this.base.append("text")
                ...
                .attr("y", (this._courtLength / 2 - this._visibleCourtLength) / 5)
                .attr("text-anchor", "middle")
                .text(this._title);
        },

        drawImage: function () {
            // this.base.append("image")
            //     .attr("xlink:href", "http://127.0.0.1:8000/api/v1"+this._image_api_path)
            //     .attr("width", "15%")
            //     .attr("height", "15%")
            //     .attr("x", 5.2)
            //     .attr("y", 28.8);
            this.base.append("image")
                .attr("xlink:href", "https://api.pulsbasketu.com/api/v1"+this._image_api_path)
                .attr("width", "15%")
                .attr("height", "15%")
                .attr("x", 7.2)
                .attr("y", 28.8);
        ...
        drawPlayers: function () {
            console.log(this._leaders_by_zones)
            const json = {
                "RIGHT_CORNER_THREE": {"x":  -1, "y": 27},
                "LEFT_CORNER_THREE": {"x":  42, "y": 27},
                "RIGHT_CORNER_MID_RANGE": {"x":  8, "y": 27},
                "LEFT_CORNER_MID_RANGE": {"x":  33, "y": 27},
                "RESTRICTED_AREA": {"x":  20.5, "y": 27},
                "PAINT": {"x":  20.5, "y": 18},
                "RIGHT_MID_RANGE": {"x":  8, "y": 18},
                "LEFT_MID_RANGE": {"x":  33, "y": 18},
                "CENTER_MID_RANGE": {"x":  20.5, "y": 10},
                "RIGHT_THREE": {"x":  4, "y": 8},
                "LEFT_THREE": {"x":  37, "y": 8},
                "CENTER_THREE": {"x":  20.5, "y": 2},
              };
              for (let key in this._leaders_by_zones) {
                if (json.hasOwnProperty(key)) {
                  let x = json[key]['x']
                  let y = json[key]['y']
                  let api_path = this._leaders_by_zones[key]['detail']['image_api_path']
                  this.base.append("image")
                  .attr("xlink:href", "http://127.0.0.1:8000/api/v1"+api_path)
                  .attr("width", "15%")
                  .attr("height", "15%")
                  .attr("x", x)
                  .attr("y", y);
        ...
        drawLegend: function () {            
            ...
            var colorYStart = visibleCourtLength - basketProtrusionLength/3 + 4;
            ...
            var sizeYStart = visibleCourtLength - basketProtrusionLength/3 + 4;
        ...
        calculateVisibleCourtLength: function () {
            ...
            this._visibleCourtLength = this._visibleCourtLength;
        },
    ...
    d3.chart.initializeDefaults(BasketballShotChart, {
        ...
        colorLegendTitle: 'EFFICIENCY BY LOCATION',
        // label for starting of hexagon color range
        colorLegendStartLabel: 'BELOW LEAGUE AVG.',
        // label for ending of hexagon color range
        colorLegendEndLabel: 'ABOVE LEAGUE AVG.',
        ...
        player: 94,
        image_api_path: "/players/1/image",
        leaders_by_zones: {},
